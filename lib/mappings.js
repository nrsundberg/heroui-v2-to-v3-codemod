...
const REMOVED_NAMED_EXPORTS = {
  ...
  // @internationalized/date — v2 re-exported these; v3 dropped the re-export.
  ...
  parseAbsolute: 'Re-exported from @internationalized/date; import directly in v3.',
  parseDuration: 'Re-exported from @internationalized/date; import directly in v3.',
  parseZonedDateTime: 'Re-exported from @internationalized/date; import directly in v3.',
  ...
  GregorianCalendar: 'Re-exported from @internationalized/date; import directly in v3.',
  ...
  startOfMonth: 'Re-exported from @internationalized/date; import directly in v3.',
  endOfMonth: 'Re-exported from @internationalized/date; import directly in v3.',
  startOfWeek: 'Re-exported from @internationalized/date; import directly in v3.',
  endOfWeek: 'Re-exported from @internationalized/date; import directly in v3.',
  startOfYear: 'Re-exported from @internationalized/date; import directly in v3.',
  endOfYear: 'Re-exported from @internationalized/date; import directly in v3.',
  isSameDay: 'Re-exported from @internationalized/date; import directly in v3.',
  isSameMonth: 'Re-exported from @internationalized/date; import directly in v3.',
  isToday: 'Re-exported from @internationalized/date; import directly in v3.',
  toCalendarDate: 'Re-exported from @internationalized/date; import directly in v3.',
  toCalendarDateTime: 'Re-exported from @internationalized/date; import directly in v3.',
  toZoned: 'Re-exported from @internationalized/date; import directly in v3.',
  // react-aria / react-aria-components — v2 re-exported these helpers;
  // v3 dropped the re-export. Import from the original package.
  VisuallyHidden: 'Re-exported from react-aria-components in v2; import directly from "react-aria-components" in v3.',
  mergeProps: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  mergeRefs: 'Re-exported from @react-aria/utils in v2; import directly from "@react-aria/utils" in v3.',
  chain: 'Re-exported from @react-aria/utils in v2; import directly from "@react-aria/utils" in v3.',
  useFocus: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useFocusRing: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useFocusVisible: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useFocusWithin: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useHover: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useInteractOutside: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useKeyboard: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  usePress: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useLongPress: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useMove: 'Re-exported from react-aria in v2; import directly from "react-aria" in v3.',
  useResizeObserver: 'Re-exported from @react-aria/utils in v2; import directly from "@react-aria/utils" in v3.',
  // react-stately / react-types — v2 re-exported types and helpers; v3 dropped them.
  ...
  Selection: 'Re-exported from @react-types/shared in v2; import directly in v3 (or inline as "all" | Set<Key>).',
  Key: 'Re-exported from @react-types/shared in v2; import as `import { Key } from "react"` instead.',
};
...
// Non-hook named exports that were renamed in v3. The import is rewritten
// (specifier renamed; user-aliased imports keep their alias) and every
// reference to the old local name in the file is renamed to the new name.
// A HEROUI-MIGRATE comment is left at the import site explaining any
// arg-shape change so the user knows what to fix manually.
const FUNCTION_RENAMES = {
  addToast: {
    to: 'toast',
    message: "addToast() renamed to toast() in v3. Inside the options object, rename `color` to `variant` and remap \"error\"->\"danger\", \"info\"->\"accent\". See https://heroui.com/docs/react/migration/toast",
  },
};
...
const STRUCTURAL_FLAG_COMPONENTS = {
  ...
  // ComboBox intentionally absent: code that already uses ComboBox is post-migration
  // (the Autocomplete entry above flagged the rename on the first pass).
